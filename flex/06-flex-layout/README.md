...
- The links in the header and footer are pushed to either side. x <!--marging padding 0 solved the indentation issue-->
...
- The buttons have an appropriate amount of padding. x <!--should have targeted button type instead of class-->
